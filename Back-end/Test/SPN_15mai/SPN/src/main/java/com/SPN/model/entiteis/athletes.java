...
public class athletes {
	...
	public athletes(int id, String nom, String prenom, String image, int age, Date date_de_naissance, sports sport,
	...
	public String toString() {
		return "athletes [id=" + id + ", nom=" + nom + ", prenom=" + prenom + ", image=" + image + ", age=" + age
				+ ", date_de_naissance=" + date_de_naissance + ", sport=" + sport + ", journal_sante_List="
				+ journal_sante_List + ", journal_performs_list=" + journal_performs_list + ", historique_entite_list="

...
public class sportsCTR {
	...
	@PostMapping("/sports")
	public sports add(@RequestBody sports sport) {
	...
	@GetMapping("/getallsportbyclub/{id}")
    public List<sports> getAllSportByclub(@PathVariable("id")int id){
        List<sports> LP=ctr.getAllSportByclub(id);
        return LP;
    }
